...
function displayText(json) {
  ...
  const hindiElement = document.getElementById('hindi');
  const arthGurmukhiElement = document.getElementById('arthGurmukhi');
  //const slide = document.querySelector('.slide');

  clearClasses();

  gurmukhiElement.innerHTML = gurbani.gurmukhi ? gurbani.gurmukhi : '';
  hindiElement.innerHTML = gurbani.hindi ? gurbani.hindi : '';
  arthGurmukhiElement.innerHTML = gurbani.arthGurmukhi ? gurbani.arthGurmukhi : '';
